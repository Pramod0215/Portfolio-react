      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <p>
              Full Stack Developer with proficiency in the following programs:
              React Js, Javascript, SQL, Python, and Python, expertise with HTML
              and CSS seeks to establish a career as the Full Stack Developer
              for Real Time Skills Private Limited. I am very familiar with Web
              Application Architecture and have worked with a good number of
            ...
            <p>
              <b>Blood:- </b>A+<br></br>
              <b>Village:-</b> Parriyawan<br></br>
             <b>Post Office:-</b> Wazirpur<br></br>
             <b>Pollice Station:-</b>  Bikram<br></br>
              <b>City:-</b> Patna-801104<br></br>
              <b>Country:-</b> India
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Experience
              ...
              jobDescription="Pedals Up - Full Stack Engineer,  Ahmedabad GJ • 03/2020 - Current"
            />
            <Experience
              startYear={"09/2019"}
              endYear={"03/2020"}
            ...
            <Skills skill="JavaScript/Ajax" progress={70} />
            <Skills skill="Html/CSS" progress={70} />
            <Skills skill="Python/Django" progress={60} />
            <Skills skill="Selenium" progress={50}/>
            <Skills skill="PostgreSql/Mysql" progress={50} />
